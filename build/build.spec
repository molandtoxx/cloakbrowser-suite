...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "cli.main",
        # ── cloakbrowser submodules ──────────────────────────────────────
        # browser.py imports these inside function bodies / if-blocks,
        # which PyInstaller's AST analysis may not trace reliably.
        "cloakbrowser",
        "cloakbrowser.config",
        "cloakbrowser.browser",
        "cloakbrowser.download",
        "cloakbrowser.geoip",
        "cloakbrowser._version",
        "cloakbrowser.human",
        "cloakbrowser.human.config",
        # ── playwright (used via function-level imports in cloakbrowser) ─
        "playwright",
